...
//        noteUid?.let { viewModal.allTodoItems(it).observe(lifecycleOwner){ l ->
//            Log.d(TAG, "onCreate: todo items $it")
//            viewModal.todoItems.addAll(l)
//            todoRVAdapter.updateTodoItems(l)
//        }}
